...
2. Replace window management with modal overlays
3. Add mobile-appropriate loading states
...
6. Submit for review
7. (Optional) Replace woozie router with react-router for native navigation patterns (gestures, transitions)
