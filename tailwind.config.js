  ...
  theme: {
    ...
    colors: (() => {
      ...
      const brandColors = {
        ...
        'primary-purple': baseColors.logoPurple[200],
        'primary-purple-disabled': baseColors.logoPurple[400],
        'primary-purple-light': baseColors.logoPurple[300],
        'primary-purple-dark': baseColors.logoPurple[700],
        'primary-purple-lighter': baseColors.purple[50],
        'primary-purple-darker': baseColors.purple[900],
