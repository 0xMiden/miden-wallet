...
const ConfirmNFTForm: FC<ConfirmNFTFormProps> = ({ nft, to, fee, feePrivate, setConfirmStatus }) => {
  return (
    <>
      <Suspense fallback={<SpinnerSection />}>
        {nft && <Form setConfirmStatus={setConfirmStatus} nft={nft} to={to} fee={fee} feePrivate={feePrivate} />}
      </Suspense>
    </>
  );
};
...
const Form: FC<FormProps> = ({ nft, to, fee, feePrivate, setConfirmStatus }) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="pt-2">
        ...
        <div className="flex justify-start mt-4">
          <img
            ...
            style={{ height: '72px' }}
          />
          <span className="text-left text-lg font-medium text-black px-4" style={{ lineHeight: '72px' }}>
      ...
      >
        <div className="flex flex-row justify-between w-full">
          <T id="cancel">
            {message => (
              <Link to="/" style={{ width: '48%' }} testID={SendNFTFormSelectors.CancelConfirmButton}>
                <Button
          ...
          <T id="confirm">
            {message => (
              <FormSubmitButton
                ...
                testID={SendNFTFormSelectors.ConfirmButton}
              >
                {message}
              </FormSubmitButton>
            )}
